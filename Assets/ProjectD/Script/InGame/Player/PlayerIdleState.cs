...
public class PlayerIdleState : FSM.FSMState
{
    public override ActorState actorState => ActorState.Idle;

    private Collider[] EnemyArray = new Collider[20];
    ...
    public override void OnStart()
    {
        if (EnemyScanCheck == null)
        {
            ...
            EnemyScanCheck.InitScan(3);
        }

        ScanDistance = 10f;
        if (fsm.target != null) fsm.ChangeState(ActorState.Attack);
    }
